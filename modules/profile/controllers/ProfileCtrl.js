app
    .controller('ProfileIndex', ['$scope', 'rest', 'toaster', '$sce', 'status', '$filter', function ($scope, rest, toaster, $sce, status, $filter) {
        console.log('Profile Controller Initialized');
    }])
    .controller('ProfileView', ['$scope', 'rest', 'toaster', function ($scope, rest, toaster) {
    ...
    .controller('ProfileCreate', ['$scope', 'rest', 'toaster', '$sce', function ($scope, rest, toaster) {
    ...
    .controller('ProfileEdit', ['$scope', 'rest', 'toaster', '$sce', function ($scope, rest, toaster) {
        ...
        $scope.save = function () {
            rest.putModel($scope.post).success(function () {
                ...
                window.setTimeout(function () {
                    document.location = 'Profile/' + $scope.post.id;
                }, 1000);
    ...
    .controller('ProfileDelete', ['$scope', 'rest', 'toaster', '$sce', function ($scope, rest, toaster) {
